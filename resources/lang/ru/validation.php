...
return [
    ...
    |
    */
    'mp3_error' => 'Прилагаемый ролик должен быть в формате MP3',
    ...
    */
    ...
    'attributes' => [
        ...
        'radio-date-begin'      => '«Радио. Дата начала»',
        'radio-date-end'        => '«Радио. Дата конца»',
        'radio-quantity'        => '«Радио. Количество дней»',
        'radio-duration'        => '«Радио. Длительность ролика»',
        'radio-price'           => '«Радио. Цена»',
        'radio-sale'            => '«Радио. Скидка»',
        'radio-file'            => '«Радио. Готовый ролик»',

        'photo-date-payment'        => '«Фотосъемка. Дата оплаты»',
        'photo-period'              => '«Фотосъемка. Количество дней»',
        'photo-cost'                => '«Фотосъемка. Стоимость»',
        'photo-company-date-begin'  => '«Фотосъемка. Дата начала»',
        'photo-company-date-end'    => '«Фотосъемка. Дата конца»',

        'promo-date-payment'        => '«Промо. Дата оплаты»',
        'promo-quantity-payment'    => '«Промо. Количество дней»',
        'promo-cost'                => '«Промо. Стоимость»',
        'promo-company-date-begin'  => '«Промо. Дата начала»',
        'promo-company-date-end'    => '«Промо. Дата конца»',

        'visual-design-total-price' => '«Визуальная. Дизайн. Стоимость»',
        'visual-design-file'        => '«Визуальная. Дизайн. Макет»',

        'visual-production-price'   => '«Визуальная. Производство. Цена»',
        'visual-production-sale'    => '«Визуальная. Производство. Скидка»',

        'visual-placement-ori'      => '«Визуальная. Размещение. ОРИ»',

        'visual-montage-date-begin' => '«Визуальная. Монтаж. Дата начала',
        'visual-montage-date-end'   => '«Визуальная. Монтаж. Дата конца»',
        'visual-montage-quantity'   => '«Визуальная. Монтаж. Количество»',
        'visual-montage-price'      => '«Визуальная. Монтаж. Цена»',
        'visual-montage-sale'       => '«Визуальная. Монтаж. Скидка»',
