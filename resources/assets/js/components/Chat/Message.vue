<template>
  <div class="sc-message">
    <div class="sc-message--content" :class="{
      ...
      <TypingMessage v-else-if="message.type === 'typing'" :activeUser="activeUser" :messageColors="determineMessageColors()" />
...
.sent > .sc-message--text:after {
    ...
    position: absolute;
    pointer-events: none;
    border-left-color: rgb(27, 137, 160);
    border-width: 7px;
    margin-top: -7px;
}
...
.received > .sc-message--text:after {
    ...
    position: absolute;
    pointer-events: none;
    border-right-color: rgb(189, 216, 223);
    border-width: 7px;
    margin-top: -7px;
}
