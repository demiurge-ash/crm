...
class VoyagerBuildingController extends BaseVoyagerController
{
    ...
    public function update(Request $request, $id)
    {
        ...
        if ( ! empty($request->file)) BuildingService::processFile($request, $id);
    ...
    public function store(Request $request)
    {
        ...
        if ( ! empty($request->file)) BuildingService::processFile($request, $data->id);
    ...
    public function destroy(Request $request, $id)
    {
        ...
        Pavilion::whereIn('building_id', [$ids])->delete();
